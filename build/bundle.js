var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-16lrqv3");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-16lrqv3");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="handwashing.gif" alt="How to wash your hand" class="svelte-wwxt9">`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
  ...
  <a href="https://freesound.org/people/metrostock99/sounds/345086/ ">
    Sound Source
    			...
    			attr(h1, "class", "svelte-1ws4us1");
    			attr(h3, "class", "svelte-1ws4us1");
    		},
    		m(target, anchor) {
